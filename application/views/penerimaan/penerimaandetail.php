...
<div class="container container-bg-white">
	...
	<div class="form-padding">
		<div class="row justify-content-end" style="margin-bottom: 10px">
			<button class="btn btn-sm btn-info btn-circle" style="margin-right: 10px" onclick="location.href='<?php echo base_url("terima/sunting/".$terima[0]->nota_pembelian) ;?>';"><img src="<?php echo base_url('assets/img/edit_button.png')?>"></button>
		...
		<div class="form-row justify-content-center">
			...
			<div class="titleform row">
				...
				<form action="<?php echo base_url('proses/input') ?>" method="post">
					...
					<div class="col-lg-1 col-form-label justify-content-end">
						<button type="submit" id="submit" <?php if ($terima[0]->status==2) {
							echo "disabled";
						}?> required class="btn btn-primary btn-circle"><img src="<?php echo base_url('assets/img/plus_button.png')?>"></button>
					</div>
