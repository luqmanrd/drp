...
<div class="container container-bg-white">
  <h5 class="titlepage">Tambah Data Supplier</h5>
  <div>
    <form action="<?php echo base_url('supplier/simpan')?>" method="post">
      <div class="row profil-margin">
        ...
        <div class="col-sm-4">
          <input type="text" class="form-control input-padding" required id="nama_supplier" name="nama_supplier" value="">
        </div>
      </div>
      <div class="row profil-margin ui-widget">
        ...
        <div class="col-sm-4">
          <input type="text" class="form-control input-padding" required id="asal_daerah" name="asal_daerah" value="">
        </div>
      </div>
      <div class="row profil-margin">
