...
<div class="container container-bg-white">
  <h5 class="titlepage">Tambah Data Intern</h5>
  <div>
    <form action="<?php echo base_url('intern/simpan')?>" method="post">
      <div class="row profil-margin">
        <div class="col-sm-5 col-form-label text-right">
          <strong>Nama Intern</strong>
        </div>
        <div class="col-sm-4">
          <input type="text" class="form-control input-padding" required id="nama_intern" name="nama_intern" value="">
        </div>
      </div>
      <div class="row profil-margin">
