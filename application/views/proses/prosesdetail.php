...
<div class="container container-bg-white">
	...
	<div class="form-padding">
		<div class="row justify-content-end" style="margin-bottom: 10px">
			<button class="btn btn-sm btn-info btn-circle" style="margin-right: 10px" onclick="location.href='<?php echo base_url("proses/sunting/".$proses[0]->nota_proses) ;?>';"><img src="<?php echo base_url('assets/img/edit_button.png')?>"></button>
